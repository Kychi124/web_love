...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2025 at 04:04 PM
...
CREATE TABLE `payments` (
  ...
  `payment_method` enum('credit_card','bank_transfer','cod','wallet') DEFAULT NULL,
...
CREATE TABLE `shipping` (
  ...
  `status` enum('pending','in_transit','delivered','failed') DEFAULT NULL,
...
INSERT INTO `users` (`user_id`, `email`, `password_hash`, `first_name`, `last_name`, `phone`, `created_at`, `updated_at`, `level`) VALUES
(1, 'admin@gmail.com', '$2y$10$f8ue78fjDv8KbTzEP7cbSOCY7q9vZd41EsAcw6k0CiwYxsFpm042e', NULL, NULL, NULL, '2025-02-09 17:41:57', '2025-02-09 18:02:51', 'admin');
...
--
ALTER TABLE `review_images`
  ADD CONSTRAINT `review_images_ibfk_1` FOREIGN KEY (`review_id`) REFERENCES `reviews` (`review_id`);
